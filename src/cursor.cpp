...
// vector<int> Cursor::GetNextForMatrix()
// {

//     Matrix *matrix = matrixCatalogue.getMatrix(this->tableName);

//     vector<int> row;
//     for (auto page_index : matrix->rows_wise_page_no[this->pagePointer])
//     {
//         const auto &it = bufferManager.getPage(this->tableName, page_index).page_data;
